...
type
  ...
  protected                    
    ...
    procedure SetNodeName(const NewName: TDomString);
  ...
  public
    ...
    procedure normalize;
    property nodeName: TDomString read GetNodeName write SetNodeName;
  ...
  public
    ...
    property tagName: TDomString read GetNodeName write SetNodeName;
...
procedure TNode.SetNodeName(const NewName: TDomString);
var
  I: Integer;
begin
  I := Pos(':', NewName);
  if I <> 0 then
  begin
    SetPrefix(Copy(NewName, 1, I - 1));
    SetLocalName(Copy(NewName, I + 1, Length(NewName) - I))
  end
  else
