...
type
  ...
  private
    ...
    function GetCurrentModuleShortPath: String;
  public
...
function TMainForm.GetCurrentModuleShortPath: String;
var
...
begin
  ...
  begin
    Result:= (activeTabInfo as TBookTabInfo).Bible.ShortPath;
  end;
