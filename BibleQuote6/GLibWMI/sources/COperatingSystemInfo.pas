...
type 
  ...
  private
    //fConnected:boolean;//AlekId:Hint
...
var
//  s:string;//AlekId:Hint
  //i:Integer;//AlekId:Hint
  //d:TDateTime;//AlekId:Hint
  v:variant;
  //vType:TWMIGenericPropType;//AlekId:Hint
  //vArr:TArrVariant;//AlekId:Hint
  vNull:boolean;
