object FAbout: TFAbout
  ...
  object pnlInfo: TPanel
    ...
    object lblMail: TLabel
      ...
      Caption = 'german_ral [arroba] hotmail [punto] com'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object Label4: TLabel
      ...
      AutoSize = False
      Caption = 
        'Programado utilizando Delphi 6.'#13#10#13#10'Esta demo utiliza las Librer'#237 +
        'as GLibWMI.'#13#10'Son una serie de componentes que utilizan la WMI de' +
        ' Windows (Windows Management Information).'#13#10#13#10'Copyright '#169' Germ'#225'n' +
        ' Est'#233'vez (Neftal'#237').'#13#10
      WordWrap = True
    end
